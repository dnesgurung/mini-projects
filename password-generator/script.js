...
const nunmbersCheckbox = document.getElementById("numbers");
...
function makePassword() {
  ...
  const includeNumbers = nunmbersCheckbox.checked;
...
function updateStrengthMeter(password) {
  ...
  // Ensure the width of the strenght bar is a valid percentage
